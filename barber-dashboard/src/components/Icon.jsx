const PATHS = {
  ...
  gauge:       <><path d="M12 21a9 9 0 1 1 9-9" /><path d="M12 12l4.5-4.5" /><circle cx="12" cy="12" r="1.4" /></>,
  dots:        <><circle cx="5" cy="12" r="1.6" /><circle cx="12" cy="12" r="1.6" /><circle cx="19" cy="12" r="1.6" /></>,
  eye:         <><path d="M2 12s3.6-6.5 10-6.5S22 12 22 12s-3.6 6.5-10 6.5S2 12 2 12z" /><circle cx="12" cy="12" r="2.8" /></>,
  download:    <><path d="M12 3v12" /><path d="M7.5 10.5L12 15l4.5-4.5" /><path d="M4 20h16" /></>,
  eyeOff:      <><path d="M10.7 6.1A9.9 9.9 0 0 1 12 6c6.4 0 10 6 10 6a17.6 17.6 0 0 1-3.2 3.9M6.3 6.9A17.4 17.4 0 0 0 2 12s3.6 6.5 10 6.5a9.6 9.6 0 0 0 4-.85" /><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2" /><path d="M3 3l18 18" /></>,
  hourglass:   <><path d="M6 2h12M6 22h12" /><path d="M6 2c0 5 6 6.5 6 10S6 17 6 22" /><path d="M18 2c0 5-6 6.5-6 10s6 5 6 10" /></>,
  store:       <><path d="M3 9.5L4.5 4h15L21 9.5" /><path d="M3 9.5a2.5 2.5 0 0 0 5 0 2.5 2.5 0 0 0 5 0 2.5 2.5 0 0 0 5 0 2.5 2.5 0 0 0 5 0" /><path d="M5 9.5V20h14V9.5" /><path d="M9.5 20v-6h5v6" /></>,
}
