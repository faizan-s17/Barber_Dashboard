...
export default function Dashboard({ operatorEmail, onSignOut }) {
      ...
      <div className="cc-topbar">
        <div className="cc-brand">
          ...
          <div className="cc-brand-text">
            ...
            <span>Barber shop onboarding</span>
          </div>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <span style={{ fontSize: 13, color: 'var(--text-dim)' }}>{operatorEmail}</span>
          <button className="cc-btn cc-btn-ghost" onClick={onSignOut}>Sign out</button>
        </div>
      </div>

      <div className="cc-main" style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
